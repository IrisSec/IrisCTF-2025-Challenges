# IrisCTF 2025 rev-lifetime
To build the challenge:
```
make ctf # ignore test failure
python3 generate_chal_parts.py
python3 compile_ctf_final_to_c.py chal.c
clang chal.c -O3 -o chal -lcrypto
```
