...
int main(void) {
    ...
    fp_req = fopen("/tmp/sphincs_ver", "r");
    ...
    if(ret_val == -2) {
        printf("This signature isn't 1337 enough for me.\n");
    } else if(ret_val == 0 && mlen1 == (sizeof(giveflag)-1) && memcmp(m1, giveflag, sizeof(giveflag)-1) == 0) {
        system("cat /flag");
        exit(0);
    }
